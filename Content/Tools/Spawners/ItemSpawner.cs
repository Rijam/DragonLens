...
namespace DragonLens.Content.Tools.Spawners
{
	...
	internal class ItemBrowser : Browser
	{
		...
		public override void SetupFilters(FilterPanel filters)
		{
			...
			filters.AddFilter(new Filter("DragonLens/Assets/Filters/Tools", "Tools.ItemSpawner.Filters.Tools", n => n is ItemButton ib && ib.item.pick == 0 && ib.item.axe == 0 && ib.item.hammer == 0));
